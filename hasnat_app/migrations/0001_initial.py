    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bugs', to='hasnat_app.project')),
            ],
        ),
        migrations.CreateModel(
            name='Screenshot',
            fields=[
                ...
                ('bug', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='screenshots', to='hasnat_app.bug')),
            ],
        ),
    ]
